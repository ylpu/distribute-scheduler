...
import com.yl.distribute.scheduler.common.bean.JobPlanInstance;
...
public class PlanJob implements Job{
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        JobPlanInstance plan = (JobPlanInstance) jobExecutionContext.getJobDetail().getJobDataMap().get("data");
