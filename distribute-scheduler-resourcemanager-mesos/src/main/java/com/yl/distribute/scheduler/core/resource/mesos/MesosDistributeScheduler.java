...
public class MesosDistributeScheduler implements Scheduler {

	private final static Log LOGGER = LogFactory.getLog(MesosDistributeScheduler.class);
	...
	public MesosDistributeScheduler(Protos.ExecutorInfo pinUserProfileExecutor , Protos.ExecutorInfo pinUserBoardExecutor ) {
		this(pinUserProfileExecutor,pinUserBoardExecutor, 5, "http://www.pinterest.com/techcrunch");

	}

	public MesosDistributeScheduler(Protos.ExecutorInfo pinUserProfileExecutor,Protos.ExecutorInfo pinUserBoardExecutor,  int totalTasks, String url) {
